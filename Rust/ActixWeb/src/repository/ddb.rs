...
///This file is the Data base that is being used to recieve and send data to the website.
/// As this is where main will be calling its function to run the program
...
impl DDBRepository{
    async fn init(table_name:String) -> DDBRepository{
